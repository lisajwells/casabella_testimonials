	...
	echo '<section id="footer-nav">
		<div class="one-fifth">
			...
			<a href="'. get_home_url() .'/interior-design-blog"><p>Style Guide</p></a>
                        <a href="'. get_home_url() .'/about-michele-chagnon-holbrook"><p>Design Team</p></a>
		...
		<div class="one-fifth">
			...
			<a href="'. get_home_url() .'/hire-us"><p>Product Inquiry</p></a>
		</div>

		<div class="one-fifth">
			<a href="'. get_home_url() .'/interior-design-massachusetts"><h4>Interior Design</h4></a>
			<a href="'. get_home_url() .'/home-interior-design"><p>Residential</p></a>
			<a href="'. get_home_url() .'/commercial-interior-design"><p>Commercial</p></a>
			<a href="'. get_home_url() .'/interior-design-firms"><p>Construction Phase</p></a>
			<a href="'. get_home_url() .'/interior-design-services"><p>A la Carte</p></a>
		</div>
		...
		<div class="one-fifth">
			...
			<a href="https://www.facebook.com/CasabellaInteriorsShop" target="_blank"><p>Facebook</p></a>
			<a href="https://www.pinterest.com/casabellahome/" target="_blank"><p>Pinterest</p></a>
		</div>
		</section>
