...
// take away the page title
	...
	function home_press_section() {
		echo '<div class="section" id="home-press">
			  ...
			  <div class="home-awards-logos" id="home-awards-logo_4"><img src="'. get_home_url() .'/wp-content/uploads/2017/01/cape-cod-life-seal-2016.jpg" width="115" height="auto" nopin="nopin" alt="Best of Cape Cod logo 2013" /></div>
